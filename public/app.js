...
NARRATION: Try these in your next video and watch your average view duration soar. Follow for daily editing tips!`
  ...
  if (btnProjects && btnSponsors && btnShorts && tabProjects && tabSponsors && tabShorts) {
    btnProjects.addEventListener('click', () => {
      ...
      tabShorts.classList.add('hidden');
    });
  ...
  // Render function for Shorts Ideas
  ...
  function renderShorts() {
    ...
    SHORTS_DATA.forEach((item, idx) => {
      ...
      jumpBtn.addEventListener('click', () => {
        ...
        if (targetCard) {
          // Open the card first if it's closed
          targetCard.classList.add('open');
          
          // Smooth scroll to card
          targetCard.scrollIntoView({ behavior: 'smooth', block: 'center' });
          
          // Subtle highlight visual effect
      ...
      // 2. Render Collapsible Detailed Card
      ...
      // Rotating arrow icon (short arrow)
